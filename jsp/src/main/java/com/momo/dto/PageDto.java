...
public class PageDto {
	...
	public PageDto(int totalCnt, Criteria cri) {		
		...
		// 페이지 블럭의 끝번호를 구합니다
		// 요청 페이지, 블럭당 페이지 수에 따라서 블럭의 범위가 정해짐
		// 1-10
		// 11-20
		// 21-30
		...
		System.out.println("페이지당 게시물수 : " + cri.getAmount());
		System.out.println("총 게시물의수 : " + totalCnt);
