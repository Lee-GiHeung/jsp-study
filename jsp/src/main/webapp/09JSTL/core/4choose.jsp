...
<form name="testForm">
	...
	영어 : <input type="text" name="eng" value="90"><br>
	수학 : <input type="text" name="math" value="80"><br>
	<!-- 
		폼에 버튼이 하나만 있다면 이 버튼은 submit 버튼이 됨 
		submit버튼은 폼을 전송하는 기본 이벤트가 정의되어 있음 
		
		유효성 검사(validation 체크)를 진행 하기 위해서는
		기본이벤트를 제거하는 작업을 해야함
	-->
	<button id="submitBtn">전송</button>
</form>
<!-- 동일한 페이지가 다시 요청되어 form태그 안에 요소를 출력 -->
<!-- 국어, 영어, 수학 점수가 모두 입력 되었을때만 출력 합니다 -->
