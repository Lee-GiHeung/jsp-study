...
<iframe src="../inc/otherPage.jsp" style="width:100px;heigth:100px"></iframe>

<h2>out태그 - EL표현언어를 출력 합니다</h2>
<!-- 
	value 속성을 이용해서 값을 지정하고 태그안에도 값을 지정 한 경우, 오류가 발생
	set태그를 이용해서 값을 지정 할때까지 한가지 방법으로만 지정해야함
-->
<c:set var="iTag">
	i태그는 <i>기울임</i>을 표현
</c:set>
...
<c:out value="" default="빈 문자열도 값 입니다."></c:out>
