...
<body>
	...
	<div class="container-fluid">
		...
		<p class="mb-4">
			이대 도서관에 오신걸 환영합니다.<br>이대 도서관 에서는 다양한 학술 자료와 서적을 수장하고 학문적 활동을
			지원합니다.
		</p>
					...
					<form name="searchForm">
						...
						<div class="input-group">
							<select class="form-select" name="searchField"
								...
								<option value="title" ${pageDto.cri.searchField eq 'title' ? 'selected' : ''}>
									도서명</option>
								<option value="author" ${pageDto.cri.searchField eq 'author' ? 'selected' : ''}>
									작가</option>
							</select> 
